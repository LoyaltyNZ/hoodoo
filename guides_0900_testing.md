...
Looking for examples of mock context construction inside the Hoodoo test suite is a good way to proceed if you have trouble. The above code sample was originally taken from [`secure_spec.rb`](https://github.com/LoyaltyNZ/hoodoo/blob/93cb2572a5f2c295fe34cf76bbd422325f03e81d/spec/active/active_record/secure_spec.rb#L68). For a more complex / complete example, see the tests for the Context object itself in [`context_spec.rb`](https://github.com/LoyaltyNZ/hoodoo/blob/93cb2572a5f2c295fe34cf76bbd422325f03e81d/spec/services/services/context_spec.rb#L18). This even builds a mock middleware instance based on a mock service application class.
