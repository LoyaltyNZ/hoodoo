...
describe ApiTools::Data::Types::Basket do
  it 'should match schema expectations' do
    ...
    expect(schema.properties['items']).to be_a(ApiTools::Presenters::Array)
    ...
    expect(schema.properties['items'].properties['currency_amounts']).to be_a(ApiTools::Presenters::Array)

    expect(schema.properties['items'].properties['product_id']).to be_a(ApiTools::Presenters::UUID)
    ...
    expect(schema.properties['items'].properties['product_data']).to be_a(ApiTools::Presenters::Object)
    ...
    expect(schema.properties['items'].properties['product_data'].properties['tags']).to be_a(ApiTools::Presenters::Tags)
    ...
    expect(schema.properties['totals']).to be_a(ApiTools::Presenters::Array)
    ...
    expect(schema.properties['totals'].properties['currency_code'].length).to eq(ApiTools::Data::Types::CURRENCY_CODE_MAX_LENGTH)
    expect(schema.properties['totals'].properties['qualifier']).to be_a(ApiTools::Presenters::String)
    expect(schema.properties['totals'].properties['qualifier'].length).to eq(ApiTools::Data::Types::CURRENCY_QUALIFIER_MAX_LENGTH)
