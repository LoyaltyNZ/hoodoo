...
describe ApiTools::Data::Types::CalculatorConfiguration do
  it 'should match schema expectations' do
    ...
    #
    expect(schema.properties['calculator_data'].properties['earn_currency']).to be_a(ApiTools::Presenters::Object)
    ...
    expect(schema.properties['calculator_data'].properties['earn_currency'].properties['currency_earner']).to be_a(ApiTools::Presenters::Object)
    expect(schema.properties['calculator_data'].properties['earn_currency'].properties['currency_earner'].properties['earned_via']).to be_a(ApiTools::Presenters::Hash)
    expect(schema.properties['calculator_data'].properties['earn_currency'].properties['currency_earner'].properties['default_currency_code']).to be_a(ApiTools::Presenters::Array)
    ...
    expect(schema.properties['calculator_data'].properties['earn_currency'].properties['currency_earner'].properties['earned_via'].properties['values']).to be_a(ApiTools::Presenters::Object)
    ...
    expect(schema.properties['calculator_data'].properties['earn_currency'].properties['currency_earner'].properties['earned_via'].properties['values'].properties['source_exchange_rates']).to be_a(ApiTools::Presenters::Hash)
    ...
    #
    expect(schema.properties['calculator_data'].properties['earn_vouchers']).to be_a(ApiTools::Presenters::Object)
    ...
    expect(schema.properties['calculator_data'].properties['earn_vouchers'].properties['voucher_earners']).to be_a(ApiTools::Presenters::Array)
    expect(schema.properties['calculator_data'].properties['earn_vouchers'].properties['voucher_earners'].properties['earned_via']).to be_a(ApiTools::Presenters::Object)
    expect(schema.properties['calculator_data'].properties['earn_vouchers'].properties['voucher_earners'].properties['build_with']).to be_a(ApiTools::Presenters::Object)
    ...
    expect(schema.properties['calculator_data'].properties['earn_vouchers'].properties['voucher_earners'].properties['earned_via'].properties['source_exchange_rates']).to be_a(ApiTools::Presenters::Hash)
