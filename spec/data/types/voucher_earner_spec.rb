...
describe ApiTools::Data::Types::VoucherEarner do
  it 'should match schema expectations' do
    ...
    expect(schema.properties['voucher_earners']).to be_a(ApiTools::Data::DocumentedArray)

    expect(schema.properties['voucher_earners'].properties['earned_via']).to be_a(ApiTools::Data::DocumentedObject)
    expect(schema.properties['voucher_earners'].properties['build_with']).to be_a(ApiTools::Data::DocumentedObject)
    ...
    expect(schema.properties['voucher_earners'].properties['earned_via'].properties['source_exchange_rates']).to be_a(ApiTools::Data::DocumentedHash)
