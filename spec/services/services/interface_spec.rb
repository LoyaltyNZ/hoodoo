...
class RSpecTestInterfaceInterfaceA < Hoodoo::Services::Interface
  interface 'RSpecTestInterfaceAResource' do
    ...
    to_list do
      ...
      do_not_search :created_after, :created_before, :updated_after, :updated_before
      do_not_filter :created_after, :updated_after, :created_by
    end
...
describe Hoodoo::Services::Interface do
  ...
  context 'DSL test classes' do
    ...
    it 'should be correctly configured (A)' do
      ...
      expect(RSpecTestInterfaceInterfaceA.to_list.do_not_search).to eq(['created_after', 'created_before', 'updated_after', 'updated_before'])
      expect(RSpecTestInterfaceInterfaceA.to_list.do_not_filter).to eq(['created_after', 'updated_after', 'created_by'])
