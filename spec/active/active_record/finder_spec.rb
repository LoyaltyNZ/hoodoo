...
describe Hoodoo::ActiveRecord::Finder do
  ...
  context 'new_in' do
    ...
    it 'creates with no special values' do
      instance = RSpecModelFinderTestWithDating.new_in( @context )
    ...
    it 'creates with provided attributes' do
      instance = RSpecModelFinderTestWithDating.new_in( @context, code: 'code', field_one: 'one' )
    ...
    it 'creates with a block' do
      instance = RSpecModelFinderTestWithDating.new_in( @context ) do | i |
        i.code      = 'code'
        i.field_one = 'one'
      end
    ...
    it 'creates with provided attributes and a block' do
      instance = RSpecModelFinderTestWithDating.new_in( @context, code: 'code' ) do | i |
        i.field_one = 'one'
      end
