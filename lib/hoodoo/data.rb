...
require 'hoodoo/data/types/basket_product'
...
require 'hoodoo/data/resources/mass_tag_event'
...
require 'hoodoo/data/resources/queue_processing_request'
require 'hoodoo/data/resources/queue_processing_result'
