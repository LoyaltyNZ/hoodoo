      ...
      begin
        ...
        class AMQP < Hoodoo::Client::Endpoint::HTTPBased
          ...
          private
            ...
            #
            def send_request_with_newrelic_trace( http_message, full_uri )
              newrelic_request = Hoodoo::Client::Endpoint::AMQPNewRelicRequestWrapper.new(
                http_message,
                full_uri
              )
              ...
              ::NewRelic::Agent::CrossAppTracing.tl_trace_http_request( newrelic_request ) do
                ...
                ::NewRelic::Agent.disable_all_tracing do
                  amqp_response = send_request_without_newrelic_trace( http_message, full_uri )
