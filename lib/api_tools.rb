...
require root+'service_middleware/service_endpoint/augmented_array'
...
require root+'service_implementations/service_session/permissions'
require root+'service_implementations/service_session/service_session'
