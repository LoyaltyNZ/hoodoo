...
require root+'data/resources/ledger'
...
require root+'services/middleware/string_inquirer'
require root+'services/middleware/rack_monkey_patch'
require root+'services/middleware/service_registry_drb_server'
require root+'services/middleware/amqp_log_message'
require root+'services/middleware/amqp_log_writer'
require root+'services/middleware/middleware'
require root+'services/middleware/endpoint/augmented_base'
require root+'services/middleware/endpoint/augmented_hash'
require root+'services/middleware/endpoint/augmented_array'
require root+'services/middleware/endpoint/endpoint'

require root+'services/middleware/exception_reporting/exception_reporting'
require root+'services/middleware/exception_reporting/base_reporter'
require root+'services/middleware/exception_reporting/reporters/airbrake_reporter'
require root+'services/middleware/exception_reporting/reporters/raygun_reporter'

require root+'services/services/permissions'
require root+'services/services/session'
require root+'services/services/request'
require root+'services/services/response'
require root+'services/services/context'
require root+'services/services/interface'
require root+'services/services/implementation'
require root+'services/services/application'
