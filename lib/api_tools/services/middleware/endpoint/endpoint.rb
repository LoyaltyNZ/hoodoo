...
#
# Purpose:: A subclass of Hoodoo::ServiceMiddleware in order to gain
...
#           variable, through Hoodoo::ServiceContext#resource.
#
...
module Hoodoo
  class ServiceMiddleware
    ...
    # via Hoodoo::ServiceContext#resource then use the instance methods
    ...
    class ServiceEndpoint < Hoodoo::ServiceMiddleware
      ...
      # Hoodoo::ServiceMiddleware instance, directed at the given resource.
      #
      # +middleware_instance+:: Hoodoo::ServiceMiddleware used to handle
      #                         onward requests.
      #
      ...
      #
      # Returns an Hoodoo::ServiceMiddleware::ServiceEndpoint::AugmentedArray
      # representation of the requested list of resource instances. Call
      # Hoodoo::ServiceMiddleware::ServiceEndpoint::AugmentedArray#adds_errors_to?
      # or
      # Hoodoo::ServiceMiddleware::ServiceEndpoint::AugmentedArray#platform_errors
      ...
      #
      # Returns an Hoodoo::ServiceMiddleware::ServiceEndpoint::AugmentedHash
      # representation of the requested resource instance. Call
      # Hoodoo::ServiceMiddleware::ServiceEndpoint::AugmentedHash#adds_errors_to?
      # or
      # Hoodoo::ServiceMiddleware::ServiceEndpoint::AugmentedHash#platform_errors
      # on the returned instance to detect and resolve error conditions _before_
